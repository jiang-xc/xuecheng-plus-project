...
import com.xuecheng.orders.util.IdWorkerUtils;
import com.xuecheng.orders.util.PayNotifyConfig;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Autowired
    XcPayRecordService xcPayRecordService;
    ...
    public PayRecordDto createOrder(String userId, AddOrderDto addOrderDto) {
        ...
        if (orderDetail == null || orderDetail == "") {
            XueChengPlusException.cast("课程明细不存在");
        }
        List<XcOrdersGoods> orderGoods = JSON.parseArray(orderDetail, XcOrdersGoods.class);
        //订单id
    ...
    public PayRecordDto queryPayResult(String payNo) {
        ...
        XcPayRecord payRecord = xcPayRecordService.getPayRecordByPayno(payNo);
        if (payRecord == null) {
        ...
        //重新查询支付记录
        payRecord = xcPayRecordService.getPayRecordByPayno(payNo);
        PayRecordDto payRecordDto = new PayRecordDto();
        BeanUtils.copyProperties(payRecord, payRecordDto);
        return payRecordDto;
    }
